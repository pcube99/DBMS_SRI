...
stmt = c.prepareStatement("INSERT into schema_details (schema_name, schema_ddl) values (?,?)");
stmt.setString(1, request.getParameter("schemaname"));
stmt.setString(2, "'"+ request.getParameter("schemaddl")+ "'");
stmt.executeUpdate();
