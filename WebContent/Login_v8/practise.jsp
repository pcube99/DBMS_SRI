...
function startExam(xx){
	swal({
		  title: "Are you sure to start mock exam?",
		  icon: "warning",
		  buttons: true,
		  dangerMode: true,
		})
...
<nav class="navbar navbar-dark bg-dark">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="practise.jsp" ><i class="fa fa-file"></i><strong>Practise</strong></a>
    </li>
    <li class="nav-item">
...
String comingexamquery ="select * from exam where ispractise=1";
try{
...
<a href="#" onclick="startExam('attempqa_practise.jsp?examid=<%=comingexamresultset.getString("exam_id")%>')"> <%=comingexamresultset.getString("exam_name") %></a>	</div>
