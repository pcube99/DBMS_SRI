...
stmt = c.prepareStatement("INSERT into student_profile (student_id, student_name, student_password) values ("+request.getParameter("student_id")+",'"+request.getParameter("student_name")+"','"+request.getParameter("student_password")+"');");
stmt.executeUpdate();
